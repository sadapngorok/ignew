...
class ___crack___:
    ...
    def __main__(self, user, uid, pwx):
        try:
            ...
            ___useragent = random.choice('___useragent1,___useragent2,___useragent3,___useragent4,___useragent5,___useragent6,___useragent7,___useragent8,___useragent9,___useragent10,___useragent11,___useragent12,___useragent13,___useragent14,___useragent15,___useragent16','r').read().splitlines()
