...
class ___crack___:
    ...
    def __main__(self, user, uid, pwx):
        try:
            ...
            ___useragent = random.choice('Mozilla\/5.0 (Linux; Android 5.1.1; Redmi 3 Build\/LMY47V; wv) AppleWebKit\/537.36 (KHTML, like Gecko) Version\/4.0 Chrome\/59.0.3071.125 Mobile Safari\/537.36 Instagram 27.0.0.11.97 Android (22\/5.1.1; 320dpi; 720x1280; Xiaomi; Redmi 3; ido; qcom; ru_RU)')
